...
class AreaSeeder extends Seeder
{
    ...
    private function inferAreaFromPackage(string $packageName): string
    {
        ...
        if (str_contains($name, 'KRIAN')) {
            return 'SKYNET-KRIAN';
        }
        if (str_contains($name, 'WAJAK')) {
            return 'SKYNET-WAJAK';
        }
        if (str_contains($name, 'BUMIAYU')) {
            return 'SKYNET-BUMIAYU';
        }
        if (str_contains($name, 'KENDIT')) {
            return 'SKYNET-KENDIT';
        }
        if (str_contains($name, 'PASURUAN')) {
            return 'SKYNET-PASURUAN';
        }
        if (str_contains($name, 'MALANG')) {
            return 'SKYNET-MALANG';
        }
        if (str_contains($name, 'BLITAR')) {
            return 'SKYNET-BLITAR';
        }
        if (str_contains($name, 'MARTOPURO')) {
            return 'SKYNET-MARTOPURO';
        }
        if (str_contains($name, 'COMBORAN')) {
            return 'SKYNET-COMBORAN';
        }
        if (str_contains($name, 'PUROWOSARI')) {
            return 'SKYNET-PURWOSARI';
        }
